...
public class AffCarte extends Affichage implements MouseListener {
	...
	public void paint() {
		...
		for(int i = 0; i < this.carte.jardiniers.size()-1; i++){
			...
			this.carte.jardiniers.get(i).oriX + this.carte.jardiniers.get(i).widthOri, this.carte.jardiniers.get(i).oriY + this.carte.jardiniers.get(i).heightOri, //position du deuxi�me coin de l'image d'origine
			null);
		}
